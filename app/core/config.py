...
class Settings(BaseSettings):
    ...
    GIAS_CONTRACT_HISTORY_START_DATE: str = "2019-01-01"
    GIAS_CONTRACT_HISTORY_WINDOW_DAYS: int = 31
    GIAS_CONTRACT_HISTORY_MAX_WINDOW_PAGES: int = 90
    GIAS_CONTRACT_HISTORY_MIN_WINDOW_SECONDS: int = 3600
    ...
    RELATED_MIN_PHONE_DIGITS: int = 9   # короче — часто локальный номер без кода города (шум)
    RELATED_MAX_CLUSTER_SIZE: int = 20  # больше — почти наверняка технический общий контакт/адрес

"""Fetch EAEU SEZ resident companies from portal.eaeunion.org (CDAC XML broker).

Сервисный слой: пагинированный обход реестра резидентов СЭЗ и парсинг строк.
Используется celery-задачей синка и тонким CLI-скриптом
scripts/fetch_eaeu_sez_residents.py.
"""

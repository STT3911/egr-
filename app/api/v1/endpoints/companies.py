...
async def get_company_profile(
    ...
    try:
        unp = int(identifier)
        cache_key = f"company_profile_v7:{unp}"
...
async def get_company_risk(
    ...
    """Риск-профиль контрагента: индекс 0–100 с расшифровкой факторов.
    ...
    Ответ содержит категории, стоп-факторы, покрытие и свежесть источников.
    """

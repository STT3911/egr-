...
# ОПФ (организационно-правовые формы) для удаления
OPF_PATTERNS = [
    # Полные названия
    ...
    r'\bк\s*\(\s*ф\s*\)\s*х\b',
    r'\bкфх\b',
    r'\bптуп\b',  # производственное торговое унитарное предприятие
    r'\bчптуп\b',
    r'\bзат\b',   # закрытое акционерное товарищество
    r'\bоат\b',   # открытое акционерное товарищество

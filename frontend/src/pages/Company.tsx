          ...
          {unp && (
            <div className="flex gap-2 flex-wrap">
              <Link to={`/company/${unp}/raw`}>
                <Button variant="outline" className="glass hover:bg-primary/10 transition-all duration-300">
                  Raw данные
                </Button>
              </Link>
              <Link to={`/company/${unp}/compare`}>
                <Button variant="outline" className="glass hover:bg-accent/10 transition-all duration-300">
                  Сравнение API
                </Button>
              </Link>
            </div>
            ...
            <Card className="glass shadow-card hover:shadow-glow transition-all duration-300 border-primary/20">
              ...
              <CardContent className="space-y-4 p-6">
                {Object.entries(fieldLabels).map(([key, label]) => {
                  ...
                  return (
                    <div key={key} className="glass p-4 rounded-lg hover:bg-primary/5 transition-all duration-300">
                      <span className="text-sm text-muted-foreground font-medium block mb-1">{label}</span>
                ...
                {profile.addresses.map((addr, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-foreground font-semibold text-sm sm:text-base mb-2 pr-6">{addr.full_address}</p>
                ...
                {profile.ved.map((v, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:gap-3 gap-2 items-start pr-6">

...
def import_locked_suppliers(json_path: str = "data/imports/locked_suppliers/locked_suppliers.json"):
    ...
    if not isinstance(data, list):
        raise ValueError("locked suppliers JSON must contain a JSON array")
...
if __name__ == "__main__":
    path = os.getenv("LOCKED_SUPPLIERS_PATH", "data/imports/locked_suppliers/locked_suppliers.json")

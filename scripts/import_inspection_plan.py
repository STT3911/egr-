...
Usage:
  python scripts/import_inspection_plan.py "C:\\Users\\User\\Downloads\\план проверок" --dry-run
  python scripts/import_inspection_plan.py "C:\\Users\\User\\Downloads\\план проверок"
"""

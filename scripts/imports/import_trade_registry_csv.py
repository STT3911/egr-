...
Usage:
  python scripts/imports/import_trade_registry_csv.py "C:\\path\\to\\trade_registry.csv" --dry-run
  python scripts/imports/import_trade_registry_csv.py "C:\\path\\to\\trade_registry.csv"
"""

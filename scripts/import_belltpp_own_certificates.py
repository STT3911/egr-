...
Usage:
  python scripts/import_belltpp_own_certificates.py fetch --output data/imports/belltpp_own_certificates/snapshot.json
  python scripts/import_belltpp_own_certificates.py import data/imports/belltpp_own_certificates/snapshot.json
  python scripts/import_belltpp_own_certificates.py sync --output data/imports/belltpp_own_certificates/snapshot.json
"""
